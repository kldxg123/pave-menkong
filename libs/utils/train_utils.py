...
class VideoFeatModelArgumentsV5_1_3_3d_7B:
    ...
    ############################ Dynamic Gate Network config ###########################################
    use_dynamic_gate: bool = field(default=False, metadata={"help": "是否使用动态门控网络"})
    dynamic_gate_hidden_dim: int = field(default=256, metadata={"help": "动态门控网络隐藏层维度"})
