...
from libs.model.pave_arch_multi_sides import PAVEMultiSidesMetaModel, PAVEMultiSidesMetaForCausalLM


class PAVEQwen2MultiSidesConfig(Qwen2Config):
    model_type = "pave_qwen2_multi_sides"


class PAVEQwen2MultiSidesModel(PAVEMultiSidesMetaModel, Qwen2Model):
    config_class = PAVEQwen2MultiSidesConfig

    def __init__(self, config: Qwen2Config):
        super(PAVEQwen2MultiSidesModel, self).__init__(config)
        

class PAVEQwen2MultiSidesForCausalLM(Qwen2ForCausalLM, PAVEMultiSidesMetaForCausalLM):
    config_class = PAVEQwen2MultiSidesConfig

    def __init__(self, config):
        super(Qwen2ForCausalLM, self).__init__(config)
        self.model = PAVEQwen2MultiSidesModel(config)
    ...
    def forward(
        ...
        second_feats: Optional[torch.FloatTensor] = None, # added for multi-sides
        ...
        if inputs_embeds is None: # this is the training or the first forward at inference
            (
                ...
                second_feats=second_feats, # added for multi-sides
...
AutoConfig.register("pave_qwen2_multi_sides", PAVEQwen2MultiSidesConfig)
AutoModelForCausalLM.register(PAVEQwen2MultiSidesConfig, PAVEQwen2MultiSidesForCausalLM)
